  ...
  const projects = [
    {
      ...
      code: "https://github.com/manipandit/shopping-cart-react",
    },
    {
      id: 2,
      src: planWithMe,
      demo: "https://plan-with-me-react.netlify.app",
      code: "https://github.com/manipandit/plan-with-me-react",
    },
    {
      id: 3,
      src: studyNotion,
      demo: "https://study-notion-react.netlify.app",
      code: "https://github.com/manipandit/study-notion-react",
    },
    {
      id: 4,
      src: topCourses,
      demo: "https://top-courses-react.netlify.app",
      code: "https://github.com/manipandit/top-courses-react",
    },
    {
      id: 5,
      src: testimonials,
      demo: "https://testimonials-react-v1.netlify.app",
      code: "https://github.com/manipandit/testimonials-react",
    },
    {
      id: 6,
      src: cryptoTracker,
      demo: "https://cryptoxtracker.netlify.app",
      code: "https://github.com/manipandit/crypto-tracker",
    },
  ];
          ...
          {projects.map(({ id, src, demo, code }) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                <button className="w-1/2 px-6  my-4 duration-200 hover:scale-105">
